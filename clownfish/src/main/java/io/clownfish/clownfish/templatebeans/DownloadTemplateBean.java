...
import io.clownfish.clownfish.utils.DownloadUtil;
...
@Scope("request")
@Component
public class DownloadTemplateBean implements Serializable {
    final transient Logger LOGGER = LoggerFactory.getLogger(DownloadTemplateBean.class);
    private PropertyUtil propertyUtil;
    DownloadUtil downloadutil;
    
    
    public DownloadTemplateBean(PropertyUtil propertyUtil) {
