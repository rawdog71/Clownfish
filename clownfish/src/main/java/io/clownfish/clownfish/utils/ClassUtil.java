...
"                        </button>")).append("\n");
    ...
    public void generateLogin(CfClass clazz, String idField, String passwordField, String authField, String adminMail) {
        ...
        html.append("\t\t\t\t\t\t\t$http.get(\"cf_sendemail?cf_job=true&to=\"+adminMail+\"&subject=Bestätigung für einen neuen Benutzer&body=Der Benutzer: \" + ").append(idField).append("Text + \" muss bestätigt werden.\");\n");
        html.append("\t\t\t\t\t\t\topenLogin()").append("\n");
