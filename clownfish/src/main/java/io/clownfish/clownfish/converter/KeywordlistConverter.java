 ...
 */
@Scope("session")
@Named("keywordlistConverterBean")
@FacesConverter(value = "keywordlistConverterBean")
@Component
public class KeywordlistConverter implements Converter, Serializable {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        if (value.compareToIgnoreCase("-1") == 0) {
            ...
            Object o = cfkeywordlistservice.findById(new Long(value));
            return o;
        }
    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if (value == null) {
            ...
            String returnname = ((CfKeywordlist) value).getId().toString();
            return  returnname;
        }
    }
