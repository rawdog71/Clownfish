 ...
 */
@Scope("session")
@Named("backendConverterBean")
@FacesConverter(value = "backendConverter")
@Component
public class BackendConverter implements Converter, Serializable {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        if (value.compareToIgnoreCase("-1") == 0) {
            ...
            Object o = cfbackendservice.findByName(value);
            return o;
        }
    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if (value == null) {
            ...
            String returnname = ((CfBackend) value).getName();
            return  returnname;
        }
    }
