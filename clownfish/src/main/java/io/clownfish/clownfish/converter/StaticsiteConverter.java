 ...
 */
@Scope("session")
@Named("staticsiteConverterBean")
@FacesConverter(value = "staticsiteConverter")
@Component
public class StaticsiteConverter implements Converter, Serializable {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        if (value.compareToIgnoreCase("-1") == 0) {
            ...
            Object o = cfstaticsiteservice.findById(new Long(value));
            return o;
        }
    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if (null == value) {
            ...
            String returnname = ((CfStaticsite) value).getId().toString();
            return  returnname;
        }
    }
