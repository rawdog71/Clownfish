...
public class RestLayoutcontent {
    ...
    @PostMapping(value = "/insertlayoutcontent", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping(value = "/updatelayoutcontent", produces = MediaType.APPLICATION_JSON_VALUE)
