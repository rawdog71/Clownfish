 ...
 */
@Entity
@Table(name = "cf_keyword", catalog = "clownfish", schema = "")
@XmlRootElement
@NamedQueries({
...
public class CfKeyword implements Serializable {
    ...
    public CfKeyword(Long id) {
        this.id = id;
    }

    public CfKeyword(Long id, String name) {
        this.id = id;
        this.name = name;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CfKeyword)) {
            return false;
        }
        CfKeyword other = (CfKeyword) object;
