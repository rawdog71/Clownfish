...
@NamedQueries({
    ...
    @NamedQuery(name = "CfList.findNotInList", query = "SELECT l FROM CfList l WHERE l.classref.id NOT IN (SELECT am.ref FROM CfAccessmanager am WHERE am.type = 0 AND am.refclasscontent <> :refclasscontent)"),
})
