...
@NamedQueries({
    ...
    @NamedQuery(name = "CfClasscontent.findByMaintenance", query = "SELECT cc FROM CfClasscontent cc INNER JOIN CfClass c ON cc.classref = c.id WHERE c.maintenance = :maintenance")
